...
<section class="content">
	...
	@endif
	<form action="{{ route('admin_service_add') }}" method="post" enctype="multipart/form-data">
		{{ csrf_field() }}
		...
		<div class="form-group">
			<div class="row">
				<div class="col-md-6">
					...
					<input type="text" class="form-control" id="page-link-input" name="link" placeholder="Service page link">
				</div>
				<div class="col-md-6">
